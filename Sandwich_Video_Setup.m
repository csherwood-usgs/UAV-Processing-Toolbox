% This is the general video file for the Sandwich Town Neck Beach Cam. 
...
%addpath(genpath('C:\Users\pscordato\UAV-Processing-Toolbox')) % adds folder dependencies
addpath(genpath('D:\Scodato_SSF_2018\Projects\SandwichBeachCam\extrinsic_calibration\gcp_surveys\2016-03-30_webcam_extrinsic_calibration')) % adds folder dependencies 
addpath(genpath('D:\Scodato_SSF_2018\Projects\SandwichBeachCam\images\2016\c1')) % adds folder dependencies 
addpath(genpath('D:\Scodato_SSF_2018\Projects\SandwichBeachCam\images\2016\cx')) % adds folder dependencies 
% required USER INPUT material.  Adapt to each collection
sandwichInputFile;      % this file contains all of the required inputs.
...
meta.globals.lcp = makeLCPFromCaltech(inputs.stationStr,NU,NV);
